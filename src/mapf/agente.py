...
class Agente:
    """Entidad móvil que ocupa un nodo del plano."""
    ...
    def mover(self, nodo: Nodo) -> None:
        """Mueve este agente hacia nodo."""
        self.posicion.mover_agente(nodo)

    def set_posicion(self, nodo: Nodo) -> None:
        """Asigna la posición del agente, usando un nodo sombra si hace falta."""
